...
You can scan your private skills with the exact same capabilities using the [Aguara CLI](/cli/scan) or [Aguara MCP](/ecosystem/aguara-mcp).
...
- [CLI Reference](/cli/scan) — Scan your own skills locally
- [Detection Rules](/rules/overview) — See what Aguara Watch checks for
